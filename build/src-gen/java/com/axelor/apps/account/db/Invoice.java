...
public class Invoice extends AuditableModel {
	...
	@NotNull
	private Integer operationTypeSelect = 1;
	...
	public String toString() {
		return MoreObjects.toStringHelper(this)
			...
			.add("schedulePaymentOk", getSchedulePaymentOk())
			.omitNullValues()
			.toString();
	}
}
