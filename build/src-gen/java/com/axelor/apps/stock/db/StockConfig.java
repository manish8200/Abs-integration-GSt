...
public class StockConfig extends AuditableModel {
	...
	private Boolean isDisplaySaleValueInPrinting = Boolean.FALSE;

	@Widget(title = "Display accounting value in location financial data printing")
	private Boolean isDisplayAccountingValueInPrinting = Boolean.FALSE;
