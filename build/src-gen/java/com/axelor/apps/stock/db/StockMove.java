...
public class StockMove extends AuditableModel {
	...
	@Widget(title = "Outgoing Stock Move is edited")
	private Boolean pickingIsEdited = Boolean.FALSE;

	@Widget(title = "Outgoing Stock Move edit date")
