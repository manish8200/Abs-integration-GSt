...
@Entity
@Table(name = "SALE_SALE_ORDER", uniqueConstraints = { @UniqueConstraint(columnNames = { "saleOrderSeq", "company" }) }, indexes = { @Index(columnList = "company"), @Index(columnList = "fullName"), @Index(columnList = "currency"), @Index(columnList = "client_partner"), @Index(columnList = "contact_partner"), @Index(columnList = "main_invoicing_address"), @Index(columnList = "price_list"), @Index(columnList = "delivery_address"), @Index(columnList = "duration"), @Index(columnList = "saleman_user"), @Index(columnList = "team"), @Index(columnList = "confirmed_by_user"), @Index(columnList = "cancel_reason"), @Index(columnList = "template_user"), @Index(columnList = "company_bank_details"), @Index(columnList = "opportunity"), @Index(columnList = "trading_name"), @Index(columnList = "printing_settings"), @Index(columnList = "payment_mode"), @Index(columnList = "payment_condition"), @Index(columnList = "stock_location"), @Index(columnList = "shipment_mode"), @Index(columnList = "freight_carrier_mode"), @Index(columnList = "carrier_partner"), @Index(columnList = "forwarder_partner"), @Index(columnList = "incoterm") })
...
public class SaleOrder extends AuditableModel {
	...
	public Boolean getHasSubLineDefaultValue() {
		return hasSubLineDefaultValue == null ? Boolean.FALSE : hasSubLineDefaultValue;
	}
	...
	public String toString() {
		return MoreObjects.toStringHelper(this)
			...
			.add("hasSubLineDefaultValue", getHasSubLineDefaultValue())
			.add("inAti", getInAti())
